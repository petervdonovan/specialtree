...
pub mod parse {
    ...
    pub fn f<'a>(source: &'a str) -> (cds::Heap, Cstfy<cds::Heap, cds::F>) {
        let fnl: fnlut::ParseWitness<'a> = crate::parse::fnlut::ParseWitness::new();
        let a0: fn(&mut Parser<'a, ()>, &mut cds::Heap, fnlut::ParseWitness<'a>) -> tymetafuncspec_core::Either<cds::Heap, cds::Nat, std_parse_error::ParseError<cds::Heap>> = fnl.a0;
        use term::fnlut::HasFn;
        let a0_: fn(&mut Parser<'a, ()>, &mut cds::Heap, fnlut::ParseWitness<'a>) -> tymetafuncspec_core::Either<cds::Heap, cds::Nat, std_parse_error::ParseError<cds::Heap>> = fnl.get::<CstfyTransparent<cds::Heap, cds::Nat>>();
        ...
        > as term::co_visit::CoVisitable<
            ...
            U16,
            pf::ParseWitness<'a>,
        >>::co_visit(&mut parser, &mut heap, fnl);
        (heap, ret)
    }
    /// generated by [parse_gen::generate_parse]
    ...
    pub fn left_operand(
        source: &str,
    ) -> (cds::Heap, Cstfy<cds::Heap, cds::LeftOperand>) {
        let mut parser = parse_adt::Parser::new(source);
        let mut heap = crate::cst::data_structure::Heap::default();
        let ret = <Cstfy<
            cds::Heap,
    ...
    pub fn right_operand(
        source: &str,
    ) -> (cds::Heap, Cstfy<cds::Heap, cds::RightOperand>) {
        let mut parser = parse_adt::Parser::new(source);
        let mut heap = crate::cst::data_structure::Heap::default();
        let ret = <Cstfy<
            cds::Heap,
    ...
    /// generated by [parse_gen::generate_parse]
    pub fn nat<'a>(source: &'a str) -> (cds::Heap, CstfyTransparent<cds::Heap, cds::Nat>) {
        let mut parser = parse_adt::Parser::new(source);
        let mut heap = crate::cst::data_structure::Heap::default();
        // let f: fn(&mut Parser<'a, ()>, &mut cds::Heap, fnlut::ParseWitness<'a>) -> tymetafuncspec_core::Either<cds::Heap, cds::Nat, std_parse_error::ParseError<cds::Heap>> = <CstfyTransparent<
        //     cds::Heap,
        //     cds::Nat,
        // > as term::co_visit::CoVisitable<
        //     Parser<'a, ()>,
        ...
        > as term::co_visit::CoVisitable<
            ...
            U16,
            pf::ParseWitness<'a>,
        >>::co_visit(&mut parser, &mut heap, crate::parse::fnlut::ParseWitness::<'a>::new());
        (heap, ret)
    }
    pub mod parsell {
...
pub mod bridge {
    ...
    pub mod words_impls {
        ...
        use crate::cst::data_structure as cds;
        impl words::Implements<ttw::L> for <cds::Heap as tt::Heap>::F {
            type LWord = ttws::F;
        }
        impl words::Implements<ttw::L> for <cds::Heap as tt::Heap>::Plus {
            type LWord = ttws::Plus;
        }
        impl words::Implements<ttw::L> for <cds::Heap as tt::Heap>::LeftOperand {
            type LWord = ttws::LeftOperand;
        }
        impl words::Implements<ttw::L> for <cds::Heap as tt::Heap>::RightOperand {
            type LWord = ttws::RightOperand;
        }
        impl words::Implements<ttw::L> for <cds::Heap as tt::Heap>::Sum {
            type LWord = ttws::Sum;
        }
        impl words::Implements<ttw::L> for <cds::Heap as tt::Heap>::Nat {
            type LWord = ttws::Nat;
        }
    }
