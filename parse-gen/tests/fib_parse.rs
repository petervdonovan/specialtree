...
pub mod bridge {
    ...
    pub mod term_impls {
        ...
        pub mod owned_impls {
            ...
            use parse_adt::cstfy::CstfyTransparent;
            use parse_adt::cstfy::Cstfy;
            impl crate::term_trait::owned::F for Cstfy<cds::Heap, cds::F> {}
            impl crate::term_trait::owned::Plus for Cstfy<cds::Heap, cds::Plus> {}
            ...
            impl crate::term_trait::owned::Sum for Cstfy<cds::Heap, cds::Sum> {}
        ...
        impl term::MapsTmf<ttw::L, BoundedNat<Heap>> for Heap {
        ...
        impl term::MapsTmf<ttw::L, Either<Heap, Nat, ParseError<Heap>>> for Heap {
