...
pub fn generate(base_path: &syn::Path, l: &LangSpecFlat, serde: bool) -> syn::ItemMod {
    let lg = LangSpecGen {
        bak: l,
        sort2rs_type,
    ...
    fn test_data_structure() {
        ...
        let expected = expect_test::expect![[r#"
            ...
            pub mod refbased {
                ...
                pub struct Fib;
                pub type NatLit = u64;
                pub struct Plus(pub crate::refbased::Nat, pub crate::refbased::Nat);
                pub struct F(pub crate::refbased::Nat);
                pub enum Nat {
                    NatLit(u64),
                    F(Box<crate::refbased::F>),
                    Plus(Box<crate::refbased::Plus>),
                }
            }
        "#]];
