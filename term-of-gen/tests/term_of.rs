...
pub mod term {
    ...
    impl<
        'a,
        RefTy: crate::extension_of::reference::Plus<'a>,
    ...
    for crate::term::TermRef<'a, RefTy::LImpl, RefTy, crate::term::marker::Plus> {
        ...
        fn fields(
            ...
            dyn Iterator<Item = term_of::Term<'a, langspec::flat::LangSpecFlat>> + 'a,
        > {
            Box::new(
                vec![
                    { let it = < RefTy as crate ::extension_of::Projection <
                    RefTy::LImpl, 0 >> ::project(self.term, self.ls);
                    term_of::Term::Algebraic(term_of::AlgebraicTerm::Sum(Box::new(crate
                    ::term::TermRef { ls : self.ls, term : it, trait_ :
                    std::marker::PhantomData, }))) }, { let it = < RefTy as crate
                    ::extension_of::Projection < RefTy::LImpl, 1 >> ::project(self.term,
                    self.ls);
                    term_of::Term::Algebraic(term_of::AlgebraicTerm::Sum(Box::new(crate
                    ::term::TermRef { ls : self.ls, term : it, trait_ :
    ...
    impl<
        'a,
        RefTy: crate::extension_of::reference::F<'a>,
    > term_of::Product<'a, langspec::flat::LangSpecFlat>
        ...
        fn get(&self) -> Option<term_of::Term<'a, langspec::flat::LangSpecFlat>> {
            [
                ...
                self
                    .term
                    .f(self.ls)
                    .map(|it| term_of::Term::Algebraic(
                        term_of::AlgebraicTerm::Product(
                            Box::new(crate::term::TermRef {
                                ls: self.ls,
                                term: it,
