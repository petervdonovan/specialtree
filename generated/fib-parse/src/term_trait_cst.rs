...
use crate::term_trait_cst::owned as ttco;
...
pub trait Heap: Sized + MapsTmf<
    ...
    type Plus: ttco::Plus<Self>;
    type LeftOperand: ttco::LeftOperand<Self>;
    type RightOperand: ttco::RightOperand<Self>;
    type F: ttco::F<Self>;
    type Sum: ttco::Sum<Self>;
    type Nat: ttco::Nat<Self>;
}
