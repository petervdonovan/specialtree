...
pub trait Heap: Sized + MapsTmf<
    ...
    > + SuperHeap<
        ...
        >>::TmfTo as TyMetaFunc>::HeapBak,
    > + SuperHeap<
        <<Self as MapsTmf<wmcaf::L, ParseMetadata<Self>>>::TmfTo as TyMetaFunc>::HeapBak,
    > + SuperHeap<
        <<Self as MapsTmf<wmcaf::L, ParseError<Self>>>::TmfTo as TyMetaFunc>::HeapBak,
    > + SuperHeap<
        <<Self as MapsTmf<
            wmcaf::L,
            Either<
    ...
    > + SuperHeap<
        ...
        >>::TmfTo as TyMetaFunc>::HeapBak,
    > + SuperHeap<
        <<Self as MapsTmf<wmcaf::L, BoundedNat<Self>>>::TmfTo as TyMetaFunc>::HeapBak,
    > + SuperHeap<
        <<Self as MapsTmf<
            wmcaf::L,
            Either<
