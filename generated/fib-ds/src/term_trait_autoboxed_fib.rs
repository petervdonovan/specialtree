...
pub mod owned {
    ...
    use crate::words_mod_autoboxed_fib as wmaf;
    use crate::words_mod_autoboxed_fib::sorts as wmafs;
    use crate::term_trait_autoboxed_fib as ttaf;
    ...
    >: CanonicallyConstructibleFrom<
        ...
        >
    where
        Heap: crate::term_trait_autoboxed_fib::Heap,
    {}
    pub trait LeftOperand<
        Heap,
    >: CanonicallyConstructibleFrom<
            Heap,
            (<Heap as InverseImplements<wmaf::L, wmafs::Nat>>::StructuralImplementor, ()),
        >
    where
        Heap: crate::term_trait_autoboxed_fib::Heap,
    {}
    ...
    >: CanonicallyConstructibleFrom<
        ...
        > + CanonicallyConstructibleFrom<
            Heap,
            (<Heap as InverseImplements<wmaf::L, wmafs::Sum>>::StructuralImplementor, ()),
        >
    where
        Heap: crate::term_trait_autoboxed_fib::Heap,
    {}
