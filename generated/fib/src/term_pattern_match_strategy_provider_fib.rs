...
impl<Heap: ttf::Heap> term::case_split::HasPatternMatchStrategyForWord<wmfs::Plus>
for PatternMatchStrategyProvider<Heap> {
    type Strategy = ((Heap::LeftOperand, (Heap::RightOperand, ())), ());
}
/// @generated by [term_pattern_match_strategy_provider_gen::impl_has_pattern_match_strategy_for]
impl<Heap: ttf::Heap> term::case_split::HasPatternMatchStrategyForWord<wmfs::LeftOperand>
for PatternMatchStrategyProvider<Heap> {
...
/// @generated by [term_pattern_match_strategy_provider_gen::impl_has_pattern_match_strategy_for]
impl<Heap: ttf::Heap> term::case_split::HasPatternMatchStrategyForWord<wmfs::F>
for PatternMatchStrategyProvider<Heap> {
    type Strategy = ((Heap::Nat, ()), ());
}
/// @generated by [term_pattern_match_strategy_provider_gen::impl_has_pattern_match_strategy_for]
impl<Heap: ttf::Heap> term::case_split::HasPatternMatchStrategyForWord<wmfs::Sum>
for PatternMatchStrategyProvider<Heap> {
    type Strategy = ((<Heap as MapsTmf<wmf::L, Set<Heap, Heap::Nat>>>::Tmf, ()), ());
}
/// @generated by [term_pattern_match_strategy_provider_gen::impl_has_pattern_match_strategy_for]
impl<Heap: ttf::Heap> term::case_split::HasPatternMatchStrategyForWord<wmfs::Nat>
for PatternMatchStrategyProvider<Heap> {
    type Strategy = (
