...
pub mod owned_impls {
    ...
    impl fib_pat::term_trait_file_pattern_fib::owned::FileRoot<tsfpf::Heap>
    for tsfpf::FileRoot {}
...
pub mod ccf_impls {
    ...
    pub mod file_root {
        ...
        impl ccf::DirectlyCanonicallyConstructibleFrom<
            ...
            (
                <<Self as Heaped>::Heap as MapsTmf<
                    L,
                    File<<Self as Heaped>::Heap, tsfpf::FileItem>,
                >>::TmfTo,
                (),
            ),
        > for tsfpf::FileRoot {
            fn construct(
                ...
                crate::term_specialized_file_pattern_fib::FileRoot::File(t.0)
            }
            fn deconstruct_succeeds(&self, heap: &<Self as Heaped>::Heap) -> bool {
                match self {
                    crate::term_specialized_file_pattern_fib::FileRoot::File(_) => true,
                    _ => false,
                }
            }
            fn deconstruct(
                ...
                match self {
                    crate::term_specialized_file_pattern_fib::FileRoot::File(t) => {
                        (t, ())
                    }
                    _ => panic!("conversion failure"),
                }
    ...
    pub mod file_item {
        ...
        > for tsfpf::FileItem {
            ...
            fn deconstruct(self, heap: &<Self as Heaped>::Heap) -> (tsfpf::Plus, ()) {
                match self {
        ...
        impl ccf::DirectlyCanonicallyConstructibleFrom<
            ...
            (tsfpf::F, ()),
        > for tsfpf::FileItem {
            fn construct(heap: &mut <Self as Heaped>::Heap, t: (tsfpf::F, ())) -> Self {
            ...
            fn deconstruct(self, heap: &<Self as Heaped>::Heap) -> (tsfpf::F, ()) {
                match self {
...
pub mod transitive_ccf {
    ...
    impl ccf::transitivity::TransitivelyUnitCcf<
        tsfpf::Heap,
        File<tsfpf::Heap, tsfpf::FileItem>,
    > for tsfpf::FileRoot {
        type Intermediary = File<tsfpf::Heap, tsfpf::FileItem>;
    }
    /// @generated by [term_specialized_impl_gen::tuc_impls]
    impl ccf::transitivity::TransitivelyUnitCcf<tsfpf::Heap, tsfpf::Plus>
    for tsfpf::FileItem {
...
pub mod ccf_auto_impls {
    ...
    term::auto_impl_ccf!(
        crate ::term_specialized_file_pattern_fib::Heap, crate
        ::term_specialized_file_pattern_fib::FileRoot
    );
    term::auto_impl_ccf!(
        crate ::term_specialized_file_pattern_fib::Heap, crate
