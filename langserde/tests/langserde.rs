/// generated by [langserde::gen]
fn parse<LImpl: crate::extension_of::LImpl>(
    input: &str,
) -> Result<(LImpl, crate::extension_of::Any<LImpl>), ()> {
    let refbased: Result<crate::data_structure::refbased::Plus, _> = serde_yml::from_str(
        input,
    );
    if let Ok(refbased) = refbased {
        ...
        return Ok((lo, crate::extension_of::Any::Plus(ret)));
    }
    let refbased: Result<crate::data_structure::refbased::F, _> = serde_yml::from_str(
        input,
    );
    if let Ok(refbased) = refbased {
        ...
        let mut lo = core::default::Default::default();
        let ret = refbased.convert(&l, &mut lo);
        return Ok((lo, crate::extension_of::Any::F(ret)));
    }
    Err(())
}
...
pub mod refbased_extension_of {
    ...
    pub mod owned {
        /// generated by [refbased_extensionof_gen::owned::gen_nat_lit]
        ...
        for crate::data_structure::refbased::NatLit {
            ...
            fn get_mut<'a, 'b: 'a>(
                &'a mut self,
                _l: &'b mut Self::LImpl,
            ) -> impl crate::extension_of::mut_reference::NatLit<
                'a,
                LImpl = Self::LImpl,
            > {
                self
    ...
    pub mod mut_reference {
        /// generated by [refbased_extensionof_gen::mut_reference::gen_nat_lit]
...
pub mod idxbased_extension_of {
    ...
    pub mod owned {
        /// generated by [idxbased_extensionof_gen::owned::nat_lit]
        impl crate::extension_of::owned::NatLit
    ...
    pub mod mut_reference {
        /// generated by [idxbased_extensionof_gen::mut_reference::gen_nat_lit]
        impl<'a> crate::extension_of::mut_reference::NatLit<'a>
        for crate::data_structure::idxbased::NatLit {
            type LImpl = crate::data_structure::idxbased::Fib;
        }
...
pub mod extension_of {
    ...
    pub trait LImpl: core::default::Default {
        ...
        >(
            &mut self,
            lo: &LImpl,
            from: crate::extension_of::Any<LImpl>,
        ) -> crate::extension_of::Any<Self> {
            use crate::extension_of::reference::Plus;
            use crate::extension_of::reference::F;
            use crate::extension_of::reference::Nat;
            match from {
                crate::extension_of::Any::NatLit(nat_lit) => {
                    crate::extension_of::Any::NatLit({
                        use crate::extension_of::owned::NatLit;
    ...
    pub enum Any<LImpl: crate::extension_of::LImpl> {
        NatLit(LImpl::NatLit),
        Plus(LImpl::Plus),
        F(LImpl::F),
        Nat(LImpl::Nat),
...
fn round_trip() {
    ...
    let (l, lo) = parse::<crate::data_structure::idxbased::Fib>(&input).unwrap();
